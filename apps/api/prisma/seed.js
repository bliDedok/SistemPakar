...
import { InputTier, KeepStatus, RuleOperator, SymptomItemType, SymptomRole, UrgencyMode, } from "../src/generated/prisma/enums";
...
function calculateCfExpert(mb, md) {
    const value = mb - md;
...
const diseases = [
    {
        ...
        name: "Measles / Campak",
        severityLevel: "high",
        description: "Campak adalah penyakit infeksi anak yang umumnya ditandai demam tinggi, batuk kering, mata berair, ruam, dan bercak Koplik.",
        advice: "Pantau demam, cukupkan cairan, dan segera periksa bila demam sangat tinggi, ruam luas, atau anak tampak lemah.",
        sourceUrl: null,
        isActive: true,
    },
    {
        ...
        name: "Malaria",
        severityLevel: "high",
        description: "Malaria pada anak dapat ditandai demam, sakit kepala, menggigil, muntah, napas cepat, dan banyak berkeringat.",
        advice: "Segera periksa ke fasilitas kesehatan, terutama bila ada demam berulang, menggigil, lemas, atau riwayat wilayah endemis.",
        sourceUrl: null,
        isActive: true,
    },
    {
        ...
        severityLevel: "high",
        description: "Demam tifoid dapat ditandai demam, sakit kepala, sakit perut, diare, sakit tenggorokan, nafsu makan menurun, dan mudah lelah.",
        advice: "Periksa ke fasilitas kesehatan bila demam menetap, anak lemas, sulit makan, atau muncul gejala berat.",
        sourceUrl: null,
        isActive: true,
    },
    {
        ...
        description: "Diare pada anak ditandai peningkatan frekuensi buang air besar, BAB cair, kram perut, mual, kembung, dan risiko dehidrasi.",
        advice: "Berikan cairan/oralit dan segera periksa bila anak sangat lemas, tidak mau minum, atau muncul tanda dehidrasi.",
        sourceUrl: null,
        isActive: true,
    },
    {
        ...
        severityLevel: "medium",
        description: "ISPA dapat ditandai demam, batuk, sakit kepala, nyeri otot, mata merah, bersin, hidung tersumbat atau berair, dan sakit tenggorokan.",
        advice: "Pantau napas anak, cukupkan cairan, dan periksa bila batuk memburuk, demam tinggi, atau anak sesak.",
        sourceUrl: null,
        isActive: true,
    },
    {
        ...
        description: "DBD pada anak dapat ditandai demam, sakit kepala, mual, muntah, ruam, gelisah, dan perdarahan ringan seperti mimisan atau gusi berdarah.",
        advice: "Segera ke fasilitas kesehatan bila ada perdarahan, muntah berulang, sangat gelisah, sangat lemah, atau demam tinggi menetap.",
        sourceUrl: null,
        isActive: true,
    },
    {
        ...
        name: "Pneumonia",
        severityLevel: "critical",
        description: "Pneumonia pada anak dapat ditandai demam, batuk, suara napas tidak normal, sesak napas, nyeri dada, lesu, dan nafsu makan menurun.",
        advice: "Segera periksa bila anak sesak, napas cepat, suara napas tidak normal, nyeri dada, atau tampak sangat lemah.",
        sourceUrl: null,
        isActive: true,
    },
    {
        ...
        severityLevel: "medium",
        description: "Cacar air dapat ditandai demam, sakit kepala, sakit tenggorokan, nafsu makan menurun, bintik merah kecil, dan lentingan berisi cairan bening.",
        advice: "Jaga kebersihan kulit, hindari menggaruk lentingan, dan periksa bila demam tinggi atau ruam tampak berat.",
        sourceUrl: null,
        isActive: true,
    },
];
...
const rules = diseases.map((disease, index) => {
    const config = diseaseRuleConfig[disease.code] ?? {
        minMatch: 2,
        priority: disease.severityLevel === "critical"
            ? 12
...
const evidenceChunks = [
    // P001 - Measles / Campak
    {
        ...
        evidenceDoi: null,
        content: "Campak adalah penyakit infeksi virus yang sangat menular. Gejala awal yang relevan untuk sistem pakar meliputi demam tinggi, batuk, hidung berair, mata merah atau berair, bercak Koplik di mulut, dan ruam kulit. Dalam sistem ini, kombinasi ruam, mata berair, batuk kering, demam tinggi, dan Koplik spots memperkuat kandidat Measles / Campak.",
    },
    {
        diseaseCode: "P001",
        ...
        evidenceDoi: null,
        content: "Campak dapat menyebabkan penyakit serius pada anak, termasuk komplikasi seperti pneumonia, diare, otitis media, dan perburukan kondisi umum. Demam tinggi, ruam luas, atau anak tampak sangat lemah perlu dipantau sebagai tanda risiko yang membutuhkan pemeriksaan tenaga kesehatan.",
    },
    {
        diseaseCode: "P001",
        ...
        evidenceDoi: null,
        content: "Jika hasil sistem menunjukkan kemungkinan Campak, orang tua disarankan memantau demam, asupan cairan, ruam, dan tanda perburukan. Hasil sistem bukan diagnosis pasti; anak perlu diperiksa oleh tenaga kesehatan terutama bila demam sangat tinggi, ruam menyebar, atau muncul tanda bahaya.",
    },
    // P002 - Malaria
    {
        diseaseCode: "P002",
        ...
        evidenceDoi: null,
        content: "Malaria dapat ditandai demam, menggigil, sakit kepala, nyeri otot, rasa lelah, mual, muntah, dan diare. Pada sistem pakar ini, kombinasi demam, menggigil, sakit kepala, muntah, banyak berkeringat, dan nafsu makan menurun mendukung kandidat Malaria.",
    },
    {
        diseaseCode: "P002",
        ...
        evidenceDoi: null,
        content: "Malaria dapat berkembang menjadi penyakit berat bila tidak ditangani. Gejala berat dapat meliputi kejang, kebingungan, koma, atau gangguan organ. Bila anak demam disertai sangat lemah, gangguan kesadaran, kejang, atau riwayat wilayah endemis, pemeriksaan medis perlu diprioritaskan.",
    },
    {
        diseaseCode: "P002",
        ...
        sourceUrl: "https://www.cdc.gov/malaria/symptoms/index.html",
        evidenceDoi: null,
        content: "Jika sistem menampilkan Malaria sebagai kandidat, pengguna perlu mempertimbangkan riwayat perjalanan atau tinggal di daerah endemis malaria. Pemeriksaan tenaga kesehatan dibutuhkan untuk konfirmasi karena diagnosis malaria memerlukan evaluasi klinis dan pemeriksaan penunjang.",
    },
    // P003 - Typhoid fever
    {
        diseaseCode: "P003",
        ...
        evidenceDoi: null,
        content: "Demam tifoid dapat menimbulkan demam tinggi berkepanjangan, kelelahan, sakit kepala, mual, nyeri perut, konstipasi atau diare, dan kadang ruam. Dalam sistem ini, kombinasi demam, sakit kepala, sakit perut, diare, nafsu makan menurun, dan mudah lelah mendukung kandidat Typhoid fever.",
    },
    {
        diseaseCode: "P003",
        ...
        sourceUrl: "https://www.cdc.gov/yellow-book/hcp/travel-associated-infections-diseases/typhoid-and-paratyphoid-fever.html",
        evidenceDoi: null,
        content: "Pada anak, gejala gastrointestinal seperti diare dan muntah dapat lebih sering muncul dibandingkan pada orang dewasa. Gejala lain yang relevan dapat berupa sakit kepala, malaise, nyeri perut, batuk kering, sakit tenggorokan, kelelahan, dan ruam rose spots.",
    },
    {
        diseaseCode: "P003",
        ...
        evidenceDoi: null,
        content: "Demam tifoid dan paratifoid dapat menjadi penyakit serius. Jika sistem menunjukkan kandidat tifoid, terutama pada demam menetap disertai sakit perut, diare, lemah, atau nafsu makan menurun, pengguna disarankan mencari pemeriksaan medis untuk konfirmasi dan tata laksana.",
    },
    // P004 - Diarrhea / Diare
    {
        diseaseCode: "P004",
        ...
        evidenceDoi: null,
        content: "Diare menyebabkan kehilangan cairan dan elektrolit melalui feses cair, muntah, keringat, urine, dan pernapasan. Risiko utama pada anak adalah dehidrasi. Dalam sistem ini, sering buang air besar, BAB cair, kram perut, mual, nafsu makan menurun, dan lesu mendukung kandidat Diarrhea / Diare.",
    },
    {
        diseaseCode: "P004",
        ...
        evidenceDoi: null,
        content: "Tanda dehidrasi berat dapat meliputi letargi berat, perubahan kesadaran, perfusi buruk, ekstremitas dingin, dan tanda penarikan kulit yang memanjang. Pada diare anak, tanda dehidrasi berat perlu diperlakukan sebagai red flag yang membutuhkan evaluasi segera.",
    },
    {
        diseaseCode: "P004",
        ...
        sourceUrl: "https://www.who.int/news-room/fact-sheets/detail/diarrhoeal-disease",
        evidenceDoi: null,
        content: "Pada diare anak, fokus awal adalah mencegah dehidrasi dengan menjaga asupan cairan. Pemeriksaan medis perlu dilakukan bila anak sangat lemah, tidak mau minum, tampak dehidrasi, BAB sangat sering, atau gejala memburuk.",
    },
    // P005 - ISPA
    {
        diseaseCode: "P005",
        ...
        evidenceDoi: null,
        content: "Infeksi saluran pernapasan atas dapat menimbulkan hidung berair, hidung tersumbat, batuk, bersin, sakit tenggorokan, sakit kepala, nyeri badan ringan, dan demam. Dalam sistem ini, batuk, bersin, hidung tersumbat atau berair, sakit tenggorokan, mata merah, dan demam mendukung kandidat ISPA.",
    },
    {
        diseaseCode: "P005",
        ...
        evidenceDoi: null,
        content: "Gejala seperti batuk, bersin, hidung berair, hidung tersumbat, sakit tenggorokan, sakit kepala, nyeri badan ringan, dan demam dapat terlihat pada infeksi pernapasan. Sebagian besar ringan, tetapi perlu dipantau bila gejala memburuk atau muncul tanda napas berat.",
    },
    {
        diseaseCode: "P005",
        ...
        sourceUrl: "https://www.cdc.gov/common-cold/about/index.html",
        evidenceDoi: null,
        content: "Jika sistem menunjukkan ISPA sebagai kandidat, orang tua dapat memantau demam, batuk, asupan cairan, dan pola napas. Pemeriksaan medis diperlukan bila anak mengalami sesak, napas cepat, demam tinggi menetap, atau tampak sangat lemah.",
    },
    // P006 - Dengue Hemorrhagic Fever / DBD
    {
        ...
        evidenceDoi: null,
        content: "Dengue dapat ditandai demam disertai sakit kepala, mual, muntah, ruam, nyeri, atau tanda perdarahan. Warning signs dengue berat meliputi nyeri perut, muntah berulang, perdarahan dari hidung atau gusi, sangat lelah, dan gelisah.",
    },
    {
        diseaseCode: "P006",
        ...
        sourceName: "CDC Yellow Book",
        sourceType: "warning_sign",
        sourceUrl: "https://www.cdc.gov/yellow-book/hcp/travel-associated-infections-diseases/dengue.html",
        evidenceDoi: null,
        content: "Tanda peringatan dengue berat meliputi nyeri perut berat, muntah persisten, perdarahan mukosa, letargi atau gelisah, pembesaran hati, dan tanda gangguan sirkulasi. Pada sistem ini, perdarahan hidung atau gusi dan sangat gelisah diperlakukan sebagai warning sign.",
    },
    {
        diseaseCode: "P006",
        ...
        sourceUrl: "https://www.cdc.gov/dengue/signs-symptoms/index.html",
        evidenceDoi: null,
        content: "Jika sistem menunjukkan DBD sebagai kandidat, pengguna disarankan segera mencari pemeriksaan medis bila ada perdarahan, muntah berulang, sangat gelisah, sangat lemah, nyeri perut, atau demam yang menetap. Hasil sistem bukan diagnosis pasti.",
    },
    // P007 - Pneumonia
    {
        diseaseCode: "P007",
    ...
    },
    {
        ...
        sourceType: "warning_sign",
        sourceUrl: "https://www.mayoclinic.org/diseases-conditions/pneumonia/symptoms-causes/syc-20354204",
        evidenceDoi: null,
        content: "Kesulitan bernapas, nyeri dada, demam tinggi menetap, dan batuk persisten merupakan tanda yang perlu mendapatkan perhatian medis. Pada sistem ini, sesak napas, suara napas tidak normal, dan nyeri dada dianggap sebagai red flag untuk urgency tinggi atau emergency.",
    },
    {
        diseaseCode: "P007",
        ...
        sourceUrl: "https://www.who.int/news-room/fact-sheets/detail/pneumonia",
        evidenceDoi: null,
        content: "Jika sistem menunjukkan Pneumonia sebagai kandidat, terutama bersama sesak napas, napas cepat, suara napas tidak normal, nyeri dada, atau anak tampak sangat lemah, pengguna disarankan segera membawa anak ke fasilitas kesehatan.",
    },
    // P008 - Varicella / Cacar Air
    {
        ...
        evidenceDoi: null,
        content: "Cacar air atau varicella ditandai ruam yang berubah menjadi lepuhan gatal berisi cairan dan kemudian menjadi keropeng. Ruam dapat muncul pada dada, punggung, wajah, dan menyebar ke bagian tubuh lain. Dalam sistem ini, bintik merah kecil dan lentingan berisi cairan bening memperkuat kandidat Varicella.",
    },
    {
        diseaseCode: "P008",
        ...
        evidenceDoi: null,
        content: "Pada anak, ruam sering menjadi tanda pertama varicella. Lesi dapat berkembang dari makula ke papula lalu vesikel sebelum berkerak. Demam ringan, malaise, sakit kepala, atau nafsu makan menurun dapat menyertai.",
    },
    {
        diseaseCode: "P008",
        ...
        sourceUrl: "https://www.cdc.gov/chickenpox/signs-symptoms/index.html",
        evidenceDoi: null,
        content: "Jika sistem menunjukkan Varicella sebagai kandidat, orang tua disarankan menjaga kebersihan kulit, menghindari garukan, dan memantau demam atau tanda infeksi kulit. Pemeriksaan medis diperlukan bila ruam berat, demam tinggi, anak sangat lemah, atau muncul komplikasi.",
    },
];
async function seedEvidenceChunks(diseaseMap) {
    for (const chunk of evidenceChunks) {
        const diseaseId = diseaseMap.get(chunk.diseaseCode);
        if (!diseaseId) {
            throw new Error(`Disease tidak ditemukan untuk EvidenceChunk: ${chunk.diseaseCode}`);
        }
        const embeddingText = [
            chunk.title,
            chunk.content,
...
async function main() {
    ...
    const symptomMap = new Map((await prisma.symptom.findMany()).map((symptom) => [symptom.code, symptom.id]));
    ...
    const diseaseMap = new Map((await prisma.disease.findMany()).map((disease) => [disease.code, disease.id]));
