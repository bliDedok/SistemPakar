...
export async function weightRoutes(app) {
    ...
    app.get("/api/admin/weights/:id", { preHandler: requireAdmin }, async (request, reply) => {
    ...
    app.post("/api/admin/weights", { preHandler: requireAdmin }, async (request, reply) => {
        try {
            const repository = new PrismaWeightRepository();
    ...
    app.put("/api/admin/weights/:id", { preHandler: requireAdmin }, async (request, reply) => {
        try {
            const { id } = request.params;
            const repository = new PrismaWeightRepository();
    ...
    app.delete("/api/admin/weights/:id", { preHandler: requireAdmin }, async (request, reply) => {
        try {
            const { id } = request.params;
            const repository = new PrismaWeightRepository();
