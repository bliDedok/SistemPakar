...
export async function diseaseRoutes(app) {
    ...
    app.get("/api/admin/diseases/:id", { preHandler: requireAdmin }, async (request, reply) => {
    ...
    app.post("/api/admin/diseases", { preHandler: requireAdmin }, async (request, reply) => {
        try {
            const repository = new PrismaDiseaseRepository();
    ...
    app.put("/api/admin/diseases/:id", { preHandler: requireAdmin }, async (request, reply) => {
        try {
            const { id } = request.params;
            const repository = new PrismaDiseaseRepository();
            const useCase = new UpdateDiseaseUseCase(repository);
            const data = await useCase.execute(id, request.body);
            return {
                success: true,
    ...
    app.delete("/api/admin/diseases/:id", { preHandler: requireAdmin }, async (request, reply) => {
        try {
            const { id } = request.params;
            const repository = new PrismaDiseaseRepository();
